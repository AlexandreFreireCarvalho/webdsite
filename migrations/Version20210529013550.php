 ...
 */
final class Version20210529013550 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product DROP FOREIGN KEY FK_D34A04AD6A3B2603');
        $this->addSql('DROP INDEX IDX_D34A04AD6A3B2603 ON product');
        $this->addSql('ALTER TABLE product CHANGE genres_id genre_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product CHANGE genre_id genres_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE product ADD CONSTRAINT FK_D34A04AD6A3B2603 FOREIGN KEY (genres_id) REFERENCES genres (id)');
        $this->addSql('CREATE INDEX IDX_D34A04AD6A3B2603 ON product (genres_id)');
    }
}
